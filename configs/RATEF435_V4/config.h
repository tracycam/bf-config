...
#define TIMER_PIN_MAPPING \
    ...
    TIMER_PIN_MAP( 1, PC9, 2, 1) \
    TIMER_PIN_MAP( 2, PC8, 2, 2) \
    TIMER_PIN_MAP( 3, PA9, 1, 3) \
    TIMER_PIN_MAP( 4, PA10, 1, 4) \
    TIMER_PIN_MAP( 5, PB0, 2, 6) \
    TIMER_PIN_MAP( 6, PB10, 1, -1) \
    TIMER_PIN_MAP( 7, PA6, 1, 7) \
    TIMER_PIN_MAP( 8, PA7, 1, 8) \
...
//DEBUG:High Voltage and current sample rate
//#define VOLTAGE_SAMPLE_RATE 250
//#define CURRENT_SAMPLE_RATE 500
