...
#define BOARD_NAME AIRBOT_H7_AIO
...
#define TIMER_PIN_MAPPING \
    TIMER_PIN_MAP( 0, PC6 , 3,  2) \
    TIMER_PIN_MAP( 1, PC7 , 3,  3) \
    TIMER_PIN_MAP( 2, PC8 , 3,  4) \
    TIMER_PIN_MAP( 3, PC9 , 3,  5) \
...
#define DEFAULT_CURRENT_METER_SCALE 40
